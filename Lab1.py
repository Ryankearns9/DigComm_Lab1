...
class Lab1(gr.top_block, Qt.QWidget):
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(4, self.samp_rate, 5e3, 1e3, window.WIN_HAMMING, 6.76))
        self.qtgui_freq_sink_x_0_0.set_frequency_range(self.center_freq, (self.samp_rate*2/25))
        self.qtgui_waterfall_sink_x_0.set_frequency_range(self.center_freq, (self.samp_rate*2/25))
